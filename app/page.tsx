...
const releases = [
  { title: 'Riviera Nights', number: '001', year: '2026', mood: 'Golden hour · Coastal drive', image: '/riviera-nights.png', albumImage: '/album-riviera-nights-cd.png', discScale: 1, youtube: 'https://youtu.be/d-JhjZPDxJM?si=7LMkOFFHgJgczrTN' },
  { title: 'Vinyl Nights', number: '002', year: '2026', mood: 'After dark · Velvet grooves', image: '/album-vinyl-nights-cd.png', albumImage: '/album-vinyl-nights-cd.png', discScale: 0.945, youtube: 'https://www.youtube.com/@solarvelvetmusic' },
];
