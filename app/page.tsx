...
export default function Home() {
  return <main>
    ...
    <section className="listening-guide section-pad" aria-labelledby="listening-guide-title"><div className="listening-intro"><p className="kicker">MUSIC FOR THE ROOM</p><h2 id="listening-guide-title">Set the mood.<br/><i>Stay awhile.</i></h2><p>Discover free to listen music on YouTube for relaxed evenings, café ambience, cocktail bars, hotel lounges, coastal drives and quiet nights at home. Choose Golden Hours for bright chill disco and nu disco, or Midnight Rooms for intimate late night R&amp;B and dreamy soul.</p><a className="button button-primary" href="https://www.youtube.com/@solarvelvetmusic" target="_blank" rel="noreferrer"><span className="play-dot"><Play size={15} fill="currentColor"/></span> Explore Solar Velvet on YouTube</a></div><div className="listening-faq"><article><h3>Looking for music for a café or bar?</h3><p>Solar Velvet blends chill disco, sunset funk, smooth R&amp;B and late night soul into long form listening made for elegant spaces and unhurried evenings.</p></article><article><h3>Need relaxing music for the evening?</h3><p>Start with Golden Hours at sunset, then move into Midnight Rooms when the lights go low. Every release links directly to the official YouTube channel.</p></article><article><h3>Can businesses play Solar Velvet publicly?</h3><p>You can listen free on YouTube. Public or commercial playback may require permission or the appropriate music licence. Contact <a href="mailto:info@solarvelvet.com">info@solarvelvet.com</a> for licensing enquiries.</p></article></div></section>
