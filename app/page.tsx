...
const releases = [
  { title: 'Riviera Nights', number: '001', year: '2026', mood: 'Solar Velvet · Chill Disco', image: '/riviera-nights.png', albumImage: '/album-riviera-nights-cd.png', discScale: 1, youtube: 'https://youtu.be/d-JhjZPDxJM?si=7LMkOFFHgJgczrTN' },
